...
public class CartServiceImpl implements CartService{
    ...
    @Override
    public Boolean judgeCartItemExist(Integer productId,Integer cartId){
    ...
    public Boolean updateCart(int productId,int numberOfProduct,CartVO cartVO){
        ...
        if (optional.isPresent()) {
            ...
            CartItem cartItem = new CartItem(cart, productId, numberOfProduct, product.getProductPrice()*(1-product.getProductDiscount()/100));
